...
public class DocumentGenerationserv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			// UploadTemplateServer ut=new
			// UploadTemplateServer("35.201.178.201",22,"ubuntu","B!zL3M786");
...
//			UploadTemplateServer ut=new UploadTemplateServer(SFservIP,22,SFservusername,SFservpass);
			...
			// UploadTemplateServer ut=new
			// UploadTemplateServer("35.221.183.246",22,"ubuntu","B!zL3M786");
			// FileUploadServer fus= new
			// FileUploadServer("35.188.238.145",22,"ubuntu","$DocTiger@123$");
			logger.info("a1 ");
			// String a=ut.connect();
			// logger.info("a "+a);
			// System.out.print("connect :: "+a);
			// String serv201path= "/home/vil/sling\\
			// tomcat/apache-tomcat-6.0.35/webapps/ROOT/TemplateLibraryAdvance/";
...
//	  	 logger.info("b "+b);
			...
			// String fp = "/home/vil/sling
			// tomcat/apache-tomcat-6.0.35/webapps/ROOT/TemplateLibrary/Doc4.docx";
			// + filename;
			String[] words;
			...
			if (templateFileVO.getInputFormat().equals(IConstants.EXTENSION_DOCX)) {
				...
				// result = objDocGenService.converEnglishxlsFileToPdf(objDocGenDTO,
				// templateFileVO);

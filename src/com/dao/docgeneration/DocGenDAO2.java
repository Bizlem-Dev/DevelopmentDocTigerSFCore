...
public class DocGenDAO2 {
	final static Logger logger = Logger.getLogger(DocGenDAO2.class);
	...
	public String CRFEHO(DocGenDTO objDocGenDTO) {
		...
		try {
			...
			if(objDocGenDTO.getATTRIBUTE5().equalsIgnoreCase("true")) {
			 s = "<p align='left'> Other Properties with DAMAC &nbsp;<input type='checkbox' checked/>Yes &nbsp;<input type='checkbox' >No <br/> (If yes please mention) : "+objDocGenDTO.getATTRIBUTE6()+"</p>";
			}else {
				s = "<p align='left'> Other Properties with DAMAC &nbsp;<input type='checkbox'/>Yes &nbsp;<input type='checkbox' checked>No <br/> (If yes please mention) : "+objDocGenDTO.getATTRIBUTE6()+"</p>";	
			}

...
public class DocGenDAO {
	final static Logger logger = Logger.getLogger(DocGenDAO.class);
    ResourceBundle bundle = ResourceBundle.getBundle("config");
    QRCode objQRCode = new QRCode();
	public String Assignment_LOA_Completed_Project(com.dto.DocGenDTO objDocGenDTO) {
		...
		try {
			...
			String[] footerText = generateFooterText(IConstants.Assignment_LOA_Completed_Project_EMPTY_SPACE,IConstants.Assignment_LOA_Completed_Project_FOOTER11,IConstants.Assignment_LOA_Completed_Project_FOOTER12,
					IConstants.Assignment_LOA_Completed_Project_FOOTER21,IConstants.Assignment_LOA_Completed_Project_FOOTER22, 
					"","","","");
			...
			Converter.createPdfInput(bundle.getString("doc_loc")+filename, bundle.getString("doc_loc")+filenamepdf,fileNameforHtmlXhtml, footerText);
	...
	private String[] generateFooterText(String emptySpace, String static11,
			String static12, String static21,
			String static22, String attribute11, String attribute12, String attribute21,
			String attribute22) {
		String[] result = new String[5];
		StringBuffer sb1 = new StringBuffer(static11);
		sb1.append(attribute11.equals("") ? IConstants.EMPTY_SPACE_FOOTER : attribute11+IConstants.SMALL_SPACE_FOOTER);

		StringBuffer sb2 = new StringBuffer(static12);
		sb2.append(attribute12.equals("") ? IConstants.EMPTY_SPACE_FOOTER : attribute12+IConstants.SMALL_SPACE_FOOTER);
		
		StringBuffer sb3 = new StringBuffer(emptySpace).append(static21);
		sb3.append(attribute21.equals("") ? IConstants.EMPTY_SPACE_FOOTER : attribute21+IConstants.SMALL_SPACE_FOOTER);
		
		StringBuffer sb4 = new StringBuffer(static22);
		sb4.append(attribute22.equals("") ? IConstants.EMPTY_SPACE_FOOTER : attribute22+IConstants.SMALL_SPACE_FOOTER);
		
		result[0]=sb1.toString();
		result[1]=sb2.toString();
		result[2]=sb3.toString();
		result[3]=sb4.toString();
		return result;
	}
	...
	public String AssignmentLOA_offplanunits(DocGenDTO objDocGenDTO) {
		...
		try {
			...
			StringWriter stringWriter = new StringWriter();
			template.process(data, stringWriter);
			/*String[] footerText = generateFooterText("",IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER11,IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER12,
					IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER21,IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER22, 
					objDocGenDTO.getATTRIBUTE58(), objDocGenDTO.getATTRIBUTE59(),objDocGenDTO.getATTRIBUTE60(),objDocGenDTO.getATTRIBUTE61());*/
			String[] footerText = generateFooterText("",IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER11,IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER12,
					IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER21,IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER22, 
					"", "","","");
			footerText[4] = IConstants.ASSIGNMENTLOA_OFF_PLAN_FOOTER31;
			// get the String from the StringWriter
			 string = stringWriter.toString();
			System.out.print(string);
			// File output
...
//			css.loadTagStyle("pre", "font-family", "Verdana, \"Bitstream Vera Sans\", Geneva, sans-serif;");
	...
	public String AssignmentLOA_PSDA_AKOYA(DocGenDTO objDocGenDTO) {
		...
		try {
			...
			String[] footerText = generateFooterText("",IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER11,IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER12,
					IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER21,IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER22, 
					"", "","","");
			footerText[4] = IConstants.ASSIGNMENTLOA_PSDA_AKOYA_FOOTER31;
			StringWriter stringWriter = new StringWriter();
			template.process(data, stringWriter);
	...
	public String AssignmentLOA_Completed_AbuDhabi(DocGenDTO objDocGenDTO) {
		...
		try {
			...
			/*String[] footerText = generateFooterText(IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_EMPTY_SPACE,IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_FOOTER11,IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_FOOTER12,
					IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_FOOTER21,IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_FOOTER22, 
					objDocGenDTO.getATTRIBUTE62(), objDocGenDTO.getATTRIBUTE63(),objDocGenDTO.getATTRIBUTE64(),objDocGenDTO.getATTRIBUTE65());*/
			String[] footerText = generateFooterText(IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_EMPTY_SPACE,IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_FOOTER11,IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_FOOTER12,
					IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_FOOTER21,IConstants.ASSIGNMENTLOA_COMPLETED_ABUDHABI_FOOTER22, 
					"", "","","");
			StringWriter stringWriter = new StringWriter();
	...
	public String AssignmentNOC_Completed(DocGenDTO objDocGenDTO) {
		...
		try {
			...
			if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("damac residences") != -1) {
			    data.put("logo", "http://34.227.23.86:8080/images/DAMAC_RESIDENCES_@_AL_JAWHARAH_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("al jawharah") != -1) {
					    data.put("logo", "http://34.227.23.86:8080/images/AL_JAWHARAH_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("aykon city") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/AYKCA_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("capital bay") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/CAPITAL_BAY_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("avanti") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/CBC_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("celestia") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/CELESTIA_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("akoya by damac") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/CHR_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("akoya oxygen") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/CLR_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("madison") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/COLR_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("commercial square") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/COMMERCIAL_SQUARE_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("damac heights") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/DAMAC_HEIGHTS._LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("damac esclusiva") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/DAMAC_ESCLUSIVA_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toUpperCase().indexOf("CONSTELLA") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/CONSTELLA_LOGO.jpg");
			    }else if(objDocGenDTO.getATTRIBUTE113().toLowerCase().indexOf("bay's edge") != -1) {
				    data.put("logo", "http://34.227.23.86:8080/images/BAY'S_EDGE_LOGO.jpg");
			    }
			    else {
			    	data.put("logo", "http://34.227.23.86:8080/images/damac_logo.png");
			    }
		    ...
		    String filenameQR = RegId+"_AssignmentNOC_Completed.png";
...
//			file.close();
	...
	public String AssignmentLOA_Qatar(DocGenDTO objDocGenDTO) {
		...
		try {
			...
			data.put("Attribute60", objDocGenDTO.getATTRIBUTE60());
			data.put("Attribute61", objDocGenDTO.getATTRIBUTE61());
			data.put("Attribute62", objDocGenDTO.getATTRIBUTE63());
			data.put("Attribute63", objDocGenDTO.getATTRIBUTE65());
			data.put("Attribute64", objDocGenDTO.getATTRIBUTE64());
			
			StringWriter stringWriter = new StringWriter();
			template.process(data, stringWriter);
			
			/*String[] footerText = generateFooterText(IConstants.ASSIGNMENTLOA_QATAR_EMPTY_SPACE, IConstants.ASSIGNMENTLOA_QATAR_FOOTER11,IConstants.ASSIGNMENTLOA_QATAR_FOOTER12,
					IConstants.ASSIGNMENTLOA_QATAR_FOOTER21,IConstants.ASSIGNMENTLOA_QATAR_FOOTER22, 
					objDocGenDTO.getATTRIBUTE62(), objDocGenDTO.getATTRIBUTE63(),objDocGenDTO.getATTRIBUTE64(),objDocGenDTO.getATTRIBUTE65());*/
			String[] footerText = generateFooterText(IConstants.ASSIGNMENTLOA_QATAR_EMPTY_SPACE, IConstants.ASSIGNMENTLOA_QATAR_FOOTER11,IConstants.ASSIGNMENTLOA_QATAR_FOOTER12,
					IConstants.ASSIGNMENTLOA_QATAR_FOOTER21,IConstants.ASSIGNMENTLOA_QATAR_FOOTER22, 
					"", "","","");
...
//			    }
		...
		//    String myCodeText = "Seller Name : Damac Crescent Properties (LLC) \n SR Type : Assignment \nReg ID : 45746 \nUnit Name :  QM/SD3/602 \nProject Name :  DAMAC HILLS - QUEENS MEADOW \nName of Document :  Assignment NOC \nDate and Time of Generation : 12-Feb-2018_11-16-42 \nCustomer Name :  TARGET GENERAL TRADING(FZE)  \n Buyer Name : AWATEF YOUSEF SBIKI \nSource :  Walk-in \nUser ID :aditya.kishor@damacgroup.com ";
...
//			logger.info("Attribute39", objDocGenDTO.getATTRIBUTE39());
			...
			StringWriter stringWriter = new StringWriter();
			template.process(data, stringWriter);
			String[] footerText = new String[6];
			footerText[2] = IConstants.UNDERTAKING_CHANGE_NAME_NATIONALITY;
			// get the String from the StringWriter
			 string = stringWriter.toString();
			System.out.print(string);
			// File output
...
//			file.close();
	...
	public String AllocationParkingAcceptance(DocGenDTO objDocGenDTO) {
		Configuration cfg = new Configuration(Configuration.DEFAULT_INCOMPATIBLE_IMPROVEMENTS);
		System.out.println("2  "+System.getProperty("java.class.path"));
		String string = "";
		String url = null;
		try {
			//Load template from source folder
			cfg.setDirectoryForTemplateLoading(new File(bundle.getString("ftl_loc")));
			Template template = cfg.getTemplate("AllocationParkingAcceptance.ftl");
			...
			data.put("Attribute5", objDocGenDTO.getATTRIBUTE5());
			data.put("Attribute6", objDocGenDTO.getATTRIBUTE6());
			String tableStart = "<table style='width: 502.2pt; border-collapse: collapse; border: none;' width='670'><tbody>";
			...
			/*int breakCount = 0;
		    int iCount = 0;*/
			for(int j=0;j<objDocGenDTO.getAttributeArrForAll().length;j++) {
				int k = j+1;
				td1 = td1 + "<td style='width: 167.4pt; border: solid #BFBFBF 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt;'><p>'Parking Space "+k+"' Identification</p></td>";
				td2 = td2 +"<td style='width: 167.4pt; border: solid #BFBFBF 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt;'><p style=''>Bay No: "+objDocGenDTO.getAttributeArrForAll()[j].getAttribute1()+"</p></td>";
				td3 = td3 +"<td style='width: 167.4pt; border: solid #BFBFBF 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt;'><p style=''>Floor: "+objDocGenDTO.getAttributeArrForAll()[j].getAttribute2()+"</p></td>";
				td4 = td4 + "<td style='width: 167.4pt; border: solid #BFBFBF 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt;'><p style=''>Building: "+objDocGenDTO.getAttributeArrForAll()[j].getAttribute3()+"</p></td>";
				td5 = td5 +"<td style='width: 167.4pt; border: solid #BFBFBF 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt;'><p style=''>Purchase Price: "+objDocGenDTO.getAttributeArrForAll()[j].getAttribute4()+"</p></td>";
				if(j == (objDocGenDTO.getAttributeArrForAll().length - 1)) {
					td1 = trS + td1 + trE;
					td2 = trS + td2 + trE;
					td3 = trS + td3 + trE;
					td4 = trS + td4 + trE;
					td5 = trS + td5 + trE;
					table = table + (tableStart + td1+td2+td3+td4+td5+tableEnd + "<br/>");
					td1 = "";
					td2 = "";
					td3 = "";
					td4 = "";
			...
			/*	breakCount = breakCount + 1;
				td1 = td1 + "<td style='width:33%;border: 1px solid black;padding: 0cm 5.4pt 0cm 5.4pt;'><p>'Parking Space "+k+"' Identification</p></td>";
				td2 = td2 +"<td style='width:33%;border: 1px solid black;padding: 0cm 5.4pt 0cm 5.4pt;'><p style=''>Bay No: "+objDocGenDTO.getAttributeArrForAll()[j].getAttribute1()+"</p></td>";
				td3 = td3 +"<td style='width:33%;border: 1px solid black;padding: 0cm 5.4pt 0cm 5.4pt;'><p style=''>Floor: "+objDocGenDTO.getAttributeArrForAll()[j].getAttribute2()+"</p></td>";
				td4 = td4 + "<td style='width:33%;border: 1px solid black;padding: 0cm 5.4pt 0cm 5.4pt;'><p style=''>Building: "+objDocGenDTO.getAttributeArrForAll()[j].getAttribute3()+"</p></td>";
				td5 = td5 +"<td style='width:33%;border: 1px solid black;padding: 0cm 5.4pt 0cm 5.4pt;'><p style=''>Purchase Price: "+objDocGenDTO.getAttributeArrForAll()[j].getAttribute4()+"</p></td>";
				if(breakCount == 3 && j != (objDocGenDTO.getAttributeArrForAll().length - 1)) {
					td1 = trS + td1 + trE;
					td2 = trS + td2 + trE;
					td3 = trS + td3 + trE;
					td4 = trS + td4 + trE;
				...
				if(j == (objDocGenDTO.getAttributeArrForAll().length - 1)) {
					if(breakCount != 3) {
						td1 = td1 + "<td style='width:33%;'><p></p></td>";
						td2 = td2 +"<td style='width:33%;'><p style=''></p></td>";
						td3 = td3 +"<td style='width:33%;'><p style=''></p></td>";
						td4 = td4 + "<td style='width:33%;'><p style=''></p></td>";
						td5 = td5 +"<td style='width:33%;'><p style=''></p></td>";
					}
					td1 = trS + td1 + trE;
					td2 = trS + td2 + trE;
					td3 = trS + td3 + trE;
					td4 = trS + td4 + trE;
					td5 = trS + td5 + trE;
					table = table + (tableStart + td1+td2+td3+td4+td5+tableEnd);
				}*/
			}
			...
			String filename = RegId+"_AllocationParkingAcceptance_"+strDate+".doc";
			//url = bundle.getString("doc_loc_ip")+filename;
			Writer file = new FileWriter (new File(bundle.getString("doc_loc")+filename));
			template.process(data, file);
			file.flush();
			file.close();
			String filenamepdf = RegId+"_AllocationParkingAcceptance_"+strDate+".pdf";
			String fileNameforHtmlXhtml = RegId+"_AllocationParkingAcceptance_"+strDate;
			Converter.createPdfInput(bundle.getString("doc_loc")+filename, bundle.getString("doc_loc")+filenamepdf,fileNameforHtmlXhtml);
			url = bundle.getString("doc_loc_ip")+filenamepdf;
			File doc = new File(bundle.getString("doc_loc") + fileNameforHtmlXhtml+".doc");
			File html = new File(bundle.getString("doc_loc")+"tmp_" + fileNameforHtmlXhtml+".html");
	...
	public String ParkingRequestOffer(DocGenDTO objDocGenDTO) {
		Configuration cfg = new Configuration(Configuration.DEFAULT_INCOMPATIBLE_IMPROVEMENTS);
		System.out.println("2  "+System.getProperty("java.class.path"));
		String string = "";
		String url = null;
		try {
			//Load template from source folder
			cfg.setDirectoryForTemplateLoading(new File(bundle.getString("ftl_loc")));
			Template template = cfg.getTemplate("ParkingRequestOffer.ftl");
			...
			String td = "";
			for(int j=0;j<objDocGenDTO.getAttributeArrForAll().length;j++) {
				td = td + "<tr><td style='width: 158.4pt; border: 1px solid black;  padding: 0cm 5.4pt 0cm 5.4pt;' width='211'><p style='text-align: justify;'><span style='font-size: 11.0pt;'>"+objDocGenDTO.getAttributeArrForAll()[j].getAttribute1()+"</span></p></td><td style='width: 207.0pt;   border: 1px solid black;  padding: 0cm 5.4pt 0cm 5.4pt;' width='276'><p style='text-align: justify;'>"+objDocGenDTO.getAttributeArrForAll()[j].getAttribute2()+"</p></td><td style='width: 117.0pt;   border: 1px solid black;  padding: 0cm 5.4pt 0cm 5.4pt;' width='156'><p style='text-align: justify;'>"+objDocGenDTO.getAttributeArrForAll()[j].getAttribute3()+"</p></td></tr>";
			}
			data.put("Attribute10", td);
			StringWriter stringWriter = new StringWriter();
			template.process(data, stringWriter);
			...
			String filename = RegId+"_ParkingRequestOffer_"+strDate+".doc";
			//url = bundle.getString("doc_loc_ip")+filename;
			Writer file = new FileWriter (new File(bundle.getString("doc_loc")+filename));
			template.process(data, file);
			file.flush();
			file.close();
			String filenamepdf = RegId+"_ParkingRequestOffer_"+strDate+".pdf";
			String fileNameforHtmlXhtml = RegId+"_ParkingRequestOffer_"+strDate;
			Converter.createPdfInput(bundle.getString("doc_loc")+filename, bundle.getString("doc_loc")+filenamepdf,fileNameforHtmlXhtml);
			url = bundle.getString("doc_loc_ip")+filenamepdf;
			File doc = new File(bundle.getString("doc_loc") + fileNameforHtmlXhtml+".doc");
			File html = new File(bundle.getString("doc_loc")+"tmp_" + fileNameforHtmlXhtml+".html");
	...
	public String UndertakingChangeNationality(DocGenDTO objDocGenDTO) {
		Configuration cfg = new Configuration(Configuration.DEFAULT_INCOMPATIBLE_IMPROVEMENTS);
		System.out.println("2  "+System.getProperty("java.class.path"));
		String string = "";
		String url = null;
		try {
			//Load template from source folder
			cfg.setDirectoryForTemplateLoading(new File(bundle.getString("ftl_loc")));
			Template template = cfg.getTemplate("UndertakingChangeNationality.ftl");
...
//			logger.info("Attribute39", objDocGenDTO.getATTRIBUTE39());
			...
			template.process(data, stringWriter);
			String[] footerText = new String[6];
			footerText[2] = IConstants.UNDERTAKING_CHANGE_NATIONALITY;
			// get the String from the StringWriter
			 string = stringWriter.toString();
			System.out.print(string);
			// File output
			...
			String filename = RegId+"_UndertakingChangeNationality_"+strDate+".doc";
			//url = bundle.getString("doc_loc_ip")+filename;
			Writer file = new FileWriter (new File(bundle.getString("doc_loc")+filename));
			template.process(data, file);
			file.flush();
			file.close();
			String filenamepdf = RegId+"_UndertakingChangeNationality_"+strDate+".pdf";
			String fileNameforHtmlXhtml = RegId+"_UndertakingChangeNationality_"+strDate;
			Converter.createPdfInput(bundle.getString("doc_loc")+filename, bundle.getString("doc_loc")+filenamepdf,fileNameforHtmlXhtml,footerText);
			url = bundle.getString("doc_loc_ip")+filenamepdf;
			File doc = new File(bundle.getString("doc_loc") + fileNameforHtmlXhtml+".doc");
			File html = new File(bundle.getString("doc_loc")+"tmp_" + fileNameforHtmlXhtml+".html");
	...
	public String ConditionalNOC(DocGenDTO objDocGenDTO) {
		Configuration cfg = new Configuration(Configuration.DEFAULT_INCOMPATIBLE_IMPROVEMENTS);
		System.out.println("2  "+System.getProperty("java.class.path"));
		String string = "";
		String url = null;
		try {
			//Load template from source folder
			cfg.setDirectoryForTemplateLoading(new File(bundle.getString("ftl_loc")));
			Template template = cfg.getTemplate("ConditionalNOC.ftl");
			...
			String filename = RegId+"_ConditionalNOC_"+strDate+".doc";
			Writer file = new FileWriter (new File(bundle.getString("doc_loc")+filename));
			template.process(data, file);
			file.flush();
			file.close();
			String filenamepdf = RegId+"_ConditionalNOC_"+strDate+".pdf";
			String fileNameforHtmlXhtml = RegId+"_ConditionalNOC_"+strDate;
			Converter.createPdfInput(bundle.getString("doc_loc")+filename, bundle.getString("doc_loc")+filenamepdf,fileNameforHtmlXhtml);
			url = bundle.getString("doc_loc_ip")+filenamepdf;
			File doc = new File(bundle.getString("doc_loc") + fileNameforHtmlXhtml+".doc");
			File html = new File(bundle.getString("doc_loc")+"tmp_" + fileNameforHtmlXhtml+".html");
